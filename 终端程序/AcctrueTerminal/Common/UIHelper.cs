...
namespace AcctrueTerminal.Common
{
    public class UIHelper
    {
        ...
        /// <returns></returns>
        public static DialogResult QuestionMsg(string message)
        {
            return MessageBox.Show(message, "请确认", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1);
        }
        #endregion
        ...
        public static string InFoSequenceListConversion(List<InfoInSequence> pm)
        {
            string str = string.Empty;
            string str1 = string.Empty;
            string str2 = string.Empty;
