...
namespace AcctrueTerminal.Common
{
    ...
    public class ToJson
    {
        ...
        /// <param name="LoadItem"></param>
        /// <returns></returns>
        public static string ExecuteSql(UrlTypeData ud)
        {
            string url = "";
            string paramurl = "";
            url = BaseCommon.BusUrl + "c=" + ud.c + "&m=" + ud.m;
        ...
        public static string ExecuteMethod(UrlTypeData ud)
        {
            ...
            string paramurl = "";
            url = BaseCommon.BusUrl + "c=" + ud.c + "&m=" + ud.m;
            paramurl = "ActionItem=" + ud.LoadItem;
        ...
        /// <param name="LoadItem"></param>
        /// <returns></returns>
        public static string ExecuteMethodGetFirstID(UrlTypeData ud)
        {
            string url = "";
            string paramurl = "";
            url = BaseCommon.BusUrl + "c=" + ud.c + "&m=" + ud.m;
        ...
        public static Dictionary<string, string> row(string str)
        {
            if (str.StartsWith("{") && str.EndsWith("}"))
            {
                ...
                str = StringReplace(str, ",\"", "エ");
                string[] cs = str.Split('エ');
        ...
        {
            if (str == "{\"results\":\"[]\"}" || str == "{\"total\":0,\"rows\":[]}")
                return new DataTable();
            char[] strs = { '}' };
            char[] strs1 = { ':' };
