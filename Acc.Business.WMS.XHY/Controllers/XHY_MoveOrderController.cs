...
namespace Acc.Business.WMS.XHY.Controllers
{
    public class XHY_MoveOrderController : MoveOrderController
    {
        ...
        public override void MoveDepots(Contract.MVC.ControllerBase.SaveEvent item)
        {
            ...
            if (comList.Count > 0)
            {
                string strSql = "update Acc_WMS_InfoMaterials set FMODEL='" + comList[0].FMODEL + "',STATUS='" + comList[0].STATUS + "',LASTINTIME='" + comList[0].LASTINTIME + "',LASTOUTTIME='" + comList[0].LASTOUTTIME + "',ORDERNO='" + comList[0].ORDERNO + "',Createdby='" + comList[0].Createdby + "',Creationdate='" + comList[0].Creationdate + "',Remark='" + comList[0].Remark + "',MCODE='" + comList[0].MCODE + "' where Code='" + mom.MATERIALCODE + "' and BATCHNO='" + mom.BATCHNO + "' and DEPOTWBS=" + mom.FROMDEPOT + " and PORTCODE=" + mom.FROMPORT;
                if(sifms.Count==0)
                    strSql += " update Acc_WMS_InfoMaterials set FMODEL='" + comList[0].FMODEL + "',STATUS='" + comList[0].STATUS + "',LASTINTIME='" + comList[0].LASTINTIME + "',LASTOUTTIME='" + comList[0].LASTOUTTIME + "',ORDERNO='" + comList[0].ORDERNO + "',Createdby='" + comList[0].Createdby + "',Creationdate='" + comList[0].Creationdate + "',Remark='" + comList[0].Remark + "',MCODE='" + comList[0].MCODE + "' where Code='" + mom.MATERIALCODE + "' and BATCHNO='" + mom.BATCHNO + "' and DEPOTWBS=" + mom.TODEPOT + " and PORTCODE=" + mom.TOPORT;
