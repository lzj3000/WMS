<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report_StockInfoMX.aspx.cs" Inherits="Acc.Manage.Views.Report_StockInfoMX" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <br/>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Label ID="Label4" runat="server">仓库:</asp:Label>
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="4000px" 
        ...
        <LocalReport ReportPath="Report\Report_rdlc\Report_StockInfoMX.rdlc">
        </LocalReport>
    </rsweb:ReportViewer>
    </form>
</body>
